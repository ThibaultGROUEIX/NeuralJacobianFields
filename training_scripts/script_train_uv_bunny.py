...
class UVExperiment(Experiment):
    def __init__(self, cpuonly=False):
        ...
        Experiment.__init__(self, "BunnyExperiment", 'Use NJF to predict UVs and supervise using distortion losses from DA Wand', cpuonly=cpuonly)
...
if __name__ == '__main__':
    ...
    sys.argv.append("./data/bunny")
    sys.argv.append("--root_dir_test")
    sys.argv.append("./data/bunny")
    sys.argv.append("--expname")
    sys.argv.append("BunnyExperiment")
